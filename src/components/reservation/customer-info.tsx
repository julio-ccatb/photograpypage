...
export function CustomerInfoStep() {
  const { reservationData, updateCustomerInfo, setCurrentStep } = useReservation()
  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <p className="text-gray-400">Por favor, completa tus datos para continuar con la reserva</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="pt-4">
          <Button type="submit" className="w-full bg-amber-500 hover:bg-amber-600 text-black rounded-full">
            Continuar
